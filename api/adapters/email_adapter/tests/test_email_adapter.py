...
from api.adapters.email_adapter.adapters.email_adapter_adapter import (
    EmailAdapterAdapter,
    EmailAdapterRequest,
    PACKET_TYPE_IN,
    PACKET_TYPE_OUT,
...
class TestErrorHandling:
    ...
    async def test_thread_uuid_deterministic(self, adapter):
        ...
        request1 = EmailAdapterRequest(event_id="test", payload={"key": "value"})
        request2 = EmailAdapterRequest(event_id="test", payload={"key": "value"})
        ...
        request3 = EmailAdapterRequest(event_id="different", payload={"key": "other"})
