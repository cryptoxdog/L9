...
class SlackWebhookRequest(BaseModel):
    ...
    type: Optional[str] = Field(None, description="Slack event type (e.g., 'event_callback', 'url_verification')")
    challenge: Optional[str] = Field(None, description="URL verification challenge from Slack")
    team_id: Optional[str] = Field(None, description="Slack team/workspace ID")
    event: Optional[dict[str, Any]] = Field(None, description="Nested event data from Slack")
...
class SlackWebhookResponse(BaseModel):
    ...
    challenge: Optional[str] = Field(None, description="Challenge response for URL verification")
