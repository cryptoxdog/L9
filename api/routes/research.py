...
class ResearchExecuteRequest(BaseModel):
    ...
    agent_count: int = Field(
        default=3, ge=1, le=10, description="Number of parallel research agents"
    )
...
__dora_block__ = {
    ...
    "audit_trail": True,
    "purpose": "Provides research components including ResearchExecuteRequest, ResearchExecuteResponse",
    "dependencies": [],
}
