...
class SlackRequestNormalizer:
    ...
    def parse_event_callback(payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        thread_uuid = SlackRequestNormalizer._generate_thread_uuid(team_id, channel_id, thread_ts)
    ...
    def parse_command(payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        thread_uuid = SlackRequestNormalizer._generate_thread_uuid(team_id, channel_id, cmd_thread_ts)
