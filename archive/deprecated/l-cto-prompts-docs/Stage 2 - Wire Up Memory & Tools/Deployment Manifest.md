============================================================================
GOD-MODE CURSOR PROMPT — L9 GMP v1.7-FIX (DETERMINISTIC, LOCKED, CORRECTIVE)
============================================================================

PURPOSE:
• Fix 3 critical clarity gaps in Stage 2 implementation
• Apply explicit error handling to prevent silent failures
• Maintain approval pipeline integrity
• Prepare repo for VPS deployment with zero ambiguity
...
```text
Path: /l9/reports/exec_report_gmp_v1.7_fix.md
```

The report MUST contain the following sections in this exact order:

1. `# EXECUTION REPORT — GMP v1.7 Corrective Fix`
2. `## TODO PLAN (LOCKED)`
3. `## TODO INDEX HASH`
...
• Create the report file at `/l9/reports/exec_report_gmp_v1.7_fix.md` and write sections 1–3
...
- [0.1] File: `/l9/path/to/file.py` Lines: 44–52 Action: Replace Target: `function_name()`
...
- [ ] Report file created at `/l9/reports/exec_report_gmp_v1.7_fix.md`
...
- [ ] Report exists at required path `/l9/reports/exec_report_gmp_v1.7_fix.md`
...
> Output verified. Report stored at `/l9/reports/exec_report_gmp_v1.7_fix.md`.
