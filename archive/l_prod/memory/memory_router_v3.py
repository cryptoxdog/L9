...
from l.memory.shared.governance_filter import governance_filter
from l.memory.shared.concurrency_manager import concurrency
from l.memory.l1.l1_query import query as l1_query
...
class MemoryRouterV3:
    ...
    def _resolve_tier(self, table: str) -> str:
        ...
        if table in META_TABLES:
            return "META"
        raise ValueError(f"Invalid table '{table}' — not part of L1/MAC/META memory schema.")
