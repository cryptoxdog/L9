...
class PermissionGraph:
    ...
    async def create_user(
        user_id: str, properties: dict[str, Any] | None = None
    ) -> bool:
        """Create a user node."""
    ...
    async def create_role(
        ...
        result = await neo4j.create_entity(
            "Role",
            role_id,
            {
                "name": role_id,
...
__dora_block__ = {
    ...
    "component_name": "Permission Graph",
    ...
    "audit_trail": True,
    "purpose": "Implements PermissionGraph for permission graph functionality",
    "dependencies": [],
}
