...
__dora_block__ = {
    ...
    "component_name": "Substrate Semantic",
    ...
    "audit_trail": True,
    "purpose": "Provides substrate semantic components including EmbeddingProvider, OpenAIEmbeddingProvider, StubEmbeddingProvider",
    "dependencies": [],
}
