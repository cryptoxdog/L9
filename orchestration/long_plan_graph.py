...
async def draft_work_node(state: LongPlanState) -> LongPlanState:
    ...
    try:
        ...
        # Stub: Create draft plan
        draft_plan = f"Draft plan for: {goal}\nConstraints: {', '.join(constraints)}"
        
        # Stub: Create draft code (if applicable)
        draft_code = None  # Would be generated by LLM if code changes needed
        
        # Stub: Create draft docs (if applicable)
        draft_docs = None  # Would be generated by LLM if docs needed
