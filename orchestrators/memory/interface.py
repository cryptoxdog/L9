...
class MemoryRequest(BaseModel):
    ...
    operation: MemoryOperation = Field(default=MemoryOperation.BATCH_WRITE, description="Operation type")
    packets: List[Dict[str, Any]] = Field(default_factory=list, description="Packets to process")
