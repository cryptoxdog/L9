...
class MetaOrchestratorRequest(BaseModel):
    ...
    min_score_threshold: float = Field(default=0.7, description="Minimum acceptable score")
...
class MetaOrchestratorResponse(BaseModel):
    ...
    alternatives: List[str] = Field(default_factory=list, description="Alternative blueprint IDs")
