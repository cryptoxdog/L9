...
class WorldModelServiceAPI:
    ...
    def get_context(
        ...
        if include_lessons and self._reflection_memory:
            lessons = self._reflection_memory.get_high_confidence_lessons(min_confidence=0.7)
        ...
        context.stats = {
            ...
            "constraint_count": len(context.active_constraints) + len(context.hidden_constraints),
